...
header_files = [
    ...
    'rosidl_typesupport_zenoh_cpp/service_type_support_decl.hpp',
]
}@
...
static service_type_support_callbacks_t _@(service.namespaced_type.name)__callbacks = {
  ...
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_zenoh_cpp, @(', '.join([package_name] + list(interface_path.parents[0].parts))), @(service.namespaced_type.name)_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_zenoh_cpp, @(', '.join([package_name] + list(interface_path.parents[0].parts))), @(service.namespaced_type.name)_Response)(),
};
...
{
  return &@('::'.join([package_name] + list(interface_path.parents[0].parts)))::typesupport_zenoh_cpp::_@(service.namespaced_type.name)__handle;
}
