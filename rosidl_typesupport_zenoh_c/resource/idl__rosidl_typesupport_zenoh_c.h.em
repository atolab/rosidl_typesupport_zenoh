// generated from rosidl_typesupport_zenoh_c/resource/idl__rosidl_typesupport_zenoh_c.h.em
// with input from @(package_name):@(interface_path)
// generated code does not contain a copyright notice
@
@#######################################################################
@# EmPy template for generating <idl>__rosidl_typesupport_zenoh_c.h files
@#
@# Context:
@#  - package_name (string)
...
header_guard_variable = '__'.join([x.upper() for x in include_parts]) + \
    '__ROSIDL_TYPESUPPORT_ZENOH_C_H_'
}@
...
@{
TEMPLATE(
    'msg__rosidl_typesupport_zenoh_c.h.em',
...
@{
TEMPLATE(
    'srv__rosidl_typesupport_zenoh_c.h.em',
